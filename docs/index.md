...
**Core principles drive.** Roadmap tracks (A = freestanding hosting, B = Linux-compat research, **N = network foundation** — N1 first-frame [ADR-066](03-adr/ADR-066-virtio-net-first-frame.md), N2 ICMP ping [ADR-067](03-adr/ADR-067-virtio-net-icmp-ping.md), N4 EL0 net sample [ADR-068](03-adr/ADR-068-el0-net-svc-sample.md), scope [ADR-063](03-adr/ADR-063-network-foundation-scope.md)) are **subordinate**. A track does not outrank a principle.
