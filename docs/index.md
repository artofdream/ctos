...
**Core principles drive.** Roadmap tracks (A = freestanding hosting, B = Linux-compat research, **N = network foundation** — N1 first-frame [ADR-066](03-adr/ADR-066-virtio-net-first-frame.md), N2 ICMP ping [ADR-067](03-adr/ADR-067-virtio-net-icmp-ping.md), N3 UDP [ADR-070](03-adr/ADR-070-n3-udp-transport.md), N3.x EL0 UDP SVC [ADR-071](03-adr/ADR-071-n3x-el0-udp-svc.md), N4 EL0 net sample [ADR-068](03-adr/ADR-068-el0-net-svc-sample.md), N5 thin TCP [ADR-074](03-adr/ADR-074-n5-thin-tcp.md), scope [ADR-063](03-adr/ADR-063-network-foundation-scope.md)) are **subordinate**. A track does not outrank a principle.
...
flowchart TD
  ...
  T["Tracks A / B / N<br/>hosting · Linux research · net first-frame<br/>subordinate — not the driver"]
  P --> L --> T
```
