...
Standing EL0 is a mile, not an application runtime. No ELF loader for third-party programs, no libc, no SMP, no GPU. [Application support](measure.md#application-support).
