...
| Landed | **FAT16 multi-cluster grow** | Guest write allocates a FAT chain and crosses a cluster boundary ([ADR-064](../03-adr/ADR-064-fat16-multi-cluster-grow.md)). |
