...
**NFR-10 / NFR-08 note (2026-09-11):** [ADR-015](../03-adr/ADR-015-ro-nx-text-data.md) revises NFR-10 text in place for the RO+NX text/data cut (`SCTLR.WXN` on). ADR-013 adds a user-TTBR0 read mile and an ASID-tagged TLB mile; the umbrella isolation row stays Planned. Standing EL0 is deferred. NFR-08 boot-to-ready CNTPCT is a measurement, not a budget. IDs unchanged.
...
- ASID isolation (dual ASID without `TLBI VMALLE1` + conflict/stale-entry probe) is observable on serial and/or `#[test_case]` (NFR-10 / ADR-013) **or** the honesty ledger says Unknown / Planned until probed. Umbrella isolation stays Planned. Do not claim PAN.
