...
Say: “isolation leftovers are closed as **locks + reopen gates** (ADR-060); PAN enable is Verified (ADR-080); taken SError / EL0 isolated remain non-Verified.” Do **not** say:
