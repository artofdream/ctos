...
8. **Honesty.** Say “EL0 issued the documented SVC ABI and the kernel performed the documented effect” only when the serial / tests pass. Do **not** say: app hosting is done, Linux ABI, POSIX, userspace, “EL0 isolated,” or “secure OS.” Standing-as-normal is [ADR-024](ADR-024-standing-el0-normal.md). Thin VFS numbers 19–23 are [ADR-027](ADR-027-thin-vfs-memfs.md). Track A A7–A9 stay Planned.
