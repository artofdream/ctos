...
- Follow-ups (not this PR): multi-cluster grow, dirent shrink helpers, `vfs::create` → FAT without breaking A6. Root `readdir`: [ADR-056](ADR-056-fat16-readdir.md). Delete: [ADR-057](ADR-057-fat16-delete.md).
