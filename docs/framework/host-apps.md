...
| --- | --- | --- |
| A process you `exec` | One linked kernel ELF. Standing EL0 is a dual-SVC stub plus A1 kernel ABI and an A2 `libctos` hello | **Planned** (loader). A1/A2 are ABI + CRT miles only. |
