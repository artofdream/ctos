...
Site source of truth: [Hosting apps / containers](../overview/hosting-apps.md). Product “hosting done” claim: **Verified** under [ADR-048](../03-adr/ADR-048-app-hosting-claim-criteria.md) / [ADR-052](../03-adr/ADR-052-sponsor-accept-app-hosting.md) (freestanding slots; containers remain non-goal). This page is extra stance. HTTPS at https://ctos.artof.link is **Verified** (2026-09-11 after #30).
...
| Linux-compat goals documented (Track B B1) | Read [ADR-031](../03-adr/ADR-031-linux-compat-goals.md) | **Documented** frame. Not Linux userspace. B6 stays Planned research. |
...
| Linux VFS vs thin ctos VFS (Track B B5) | Read [ADR-034](../03-adr/ADR-034-linux-vfs-vs-thin-ctos.md) | **Documented** concept compare. No POSIX flags / dentries in `src/`. Not a Linux filesystem. |
