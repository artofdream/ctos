...
| 28 | `net_tcp_echo` | none | Kernel-path thin TCP echo vs QEMU `guestfwd` `10.0.2.4:7` ([ADR-076](../03-adr/ADR-076-el0-tcp-svc.md)). Same probe as ADR-074, quiet. Not sockets. Not listen/accept. | `0` on success, `u64::MAX` on fail. |
