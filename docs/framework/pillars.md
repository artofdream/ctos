...
| Security | [NFR-10](../02-requirements/fr-nfr.md) | [security.md](security.md) | Threat-model v1.10 + probes before any “secure OS” claim. EL0 miles: [el0.md](el0.md) (umbrella isolation Planned; standing + TTBR1 first cut + EL1 high-VA fetch + identity `.text` range tear + live `.text` tear + ASID + SVC ABI + libctos CRT are separate rows). App hosting: [syscall.md](syscall.md) (A1 ABI + A2 CRT; Track A #31 still Planned) |
