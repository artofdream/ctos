...
**Principles drive; pillars sit under them; tracks sit under both.** Visitor-facing list: [landing — Driving principles](../index.md#driving-principles). This page is the deep hub, not a second marketing copy. Extra stance: [overview.md](overview.md), [apps-today.md](apps-today.md), [building-or-porting.md](building-or-porting.md).
