...
| Security | [NFR-10](../02-requirements/fr-nfr.md) | [security.md](security.md) | Threat model + probes before any “secure OS” claim |
| Performance | [NFR-07](../02-requirements/fr-nfr.md) | [performance.md](performance.md) | Measurable CNTPCT (or later jitter) probes; optimize only with a probe |
