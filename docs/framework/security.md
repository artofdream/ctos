# Security — threat model v1.27 (NFR-10 / ADR-011 / ADR-012 / ADR-013 / ADR-014 / ADR-015 / ADR-016 / ADR-017 / ADR-018 / ADR-019 / ADR-020 / ADR-021 / ADR-022 / ADR-023 / ADR-024 / ADR-025 / ADR-026 / ADR-027 / ADR-028 / ADR-030 / ADR-032 / ADR-037 / ADR-038 / ADR-039 / ADR-040 / ADR-041 / ADR-042 / ADR-043 / ADR-044 / ADR-045 / ADR-047 / ADR-048 / ADR-049)
...
Version: **v1.27** (2026-09-13). Slice/update of v1.26 (adds [ADR-049](../03-adr/ADR-049-identity-ram-tear.md) leftover identity RAM tear). Taken SError = deferred/non-goal on this smoke machine; PAN enable = non-goal on default cortex-a57; never yank `_start`; leftover identity RAM after the heap is torn (`ident: ram*`); umbrella “EL0 isolated” stays Planned/non-claim; product app hosting stays Planned. Not a v2 model and not “secure.”
