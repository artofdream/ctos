# Security — threat model v1.18 (NFR-10 / ADR-011 / ADR-012 / ADR-013 / ADR-014 / ADR-015 / ADR-016 / ADR-017 / ADR-018 / ADR-019 / ADR-020 / ADR-021 / ADR-022 / ADR-023 / ADR-024 / ADR-025 / ADR-026 / ADR-027 / ADR-028 / ADR-030 / ADR-032 / ADR-037 / ADR-038)
...
Version: **v1.18** (2026-09-12). Slice/update of v1.17 (adds identity heap tear: high `GlobalAlloc` VAs + `ident: heap`; PAN enable still Planned). Not a v2 model and not “secure.”
...
| Remaining isolation gaps | Shared boot-stub text in the user table (handler must fetch if VBAR were still identity). No PAN enable on cortex-a57. EL0 trampoline still `TLBI VMALLE1`. Remaining identity RAM after the heap (frame bump). Lower-EL IRQ still parks. | User TTBR0 + ASID + TTBR1 + torn live `.text` / `.rodata` / `.data`/stacks / heap + SVC ABI; isolation Planned |
...
| --- | --- | --- |
| Threat-model v1.18 written | Read this file | Verified (file + review). Still no “secure OS”. |
