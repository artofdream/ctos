...
Version: **v1.54** (2026-09-19). Slice/update of v1.53 (#124 ADR-078). PAN CPU reopen foundation ([ADR-079](../03-adr/ADR-079-pan-cpu-reopen.md) / [#125](https://github.com/artofdream/ctos/issues/125)): default `-cpu cortex-a76`, serial `pan: present`. **Enable** still locked (ADR-080). Keep N1–N5 + samples + ADR-069/072/078. Still **not** PAN enabled / “EL0 isolated” / BSD sockets / Linux/containers. Not a v2 model and not “secure.”
...
| PAN ID field | Serial `pan: id=` / `pan: present` | Capability probe ([ADR-026](../03-adr/ADR-026-pan-capability.md) / [ADR-079](../03-adr/ADR-079-pan-cpu-reopen.md)). Enable still ADR-080. |
