# Security — threat model v1.26 (NFR-10 / ADR-011 / ADR-012 / ADR-013 / ADR-014 / ADR-015 / ADR-016 / ADR-017 / ADR-018 / ADR-019 / ADR-020 / ADR-021 / ADR-022 / ADR-023 / ADR-024 / ADR-025 / ADR-026 / ADR-027 / ADR-028 / ADR-030 / ADR-032 / ADR-037 / ADR-038 / ADR-039 / ADR-040 / ADR-041 / ADR-042 / ADR-043 / ADR-044 / ADR-045 / ADR-047 / ADR-048)
...
Version: **v1.26** (2026-09-13). Slice/update of v1.25 (adds [ADR-047](../03-adr/ADR-047-isolation-leftovers-decisions.md) leftover decisions + [ADR-048](../03-adr/ADR-048-app-hosting-claim-criteria.md) app-hosting claim gate). Taken SError = deferred/non-goal on this smoke machine; PAN enable = non-goal on default cortex-a57; never yank `_start`; leftover RAM optional Planned; umbrella “EL0 isolated” stays Planned/non-claim; product app hosting stays Planned. Not a v2 model and not “secure.”
...
| Remaining isolation gaps | Shared boot-stub text stays by decision (`ident: start-stay`; never yank `_start`). PAN enable non-goal on default cortex-a57. Leftover identity RAM optional Planned (`ident: ram-stay`). Taken lower-EL SError deferred/non-goal on this smoke machine (`el0: serror-park`; A-clear dormant prep). | User TTBR0 + ASID + TTBR1 + torn live `.text` / `.rodata` / `.data`/stacks / heap + EL0 entry without `VMALLE1` + lower-EL IRQ while standing + default IRQ-unmasked ERET + lower-EL FIQ while standing + SError park honesty + A-clear dormant prep + start-stay honesty + SVC ABI; umbrella isolation Planned/non-claim ([ADR-047](../03-adr/ADR-047-isolation-leftovers-decisions.md)) |
