# Security — threat model v1.41 (NFR-10 / ADR-011 / ADR-012 / ADR-013 / ADR-014 / ADR-015 / ADR-016 / ADR-017 / ADR-018 / ADR-019 / ADR-020 / ADR-021 / ADR-022 / ADR-023 / ADR-024 / ADR-025 / ADR-026 / ADR-027 / ADR-028 / ADR-030 / ADR-032 / ADR-037 / ADR-038 / ADR-039 / ADR-040 / ADR-041 / ADR-042 / ADR-043 / ADR-044 / ADR-045 / ADR-047 / ADR-048 / ADR-049 / ADR-050 / ADR-052 / ADR-053 / ADR-054 / ADR-055 / ADR-056 / ADR-057 / ADR-058 / ADR-059 / ADR-060 / ADR-061 / ADR-062 / ADR-063 / ADR-064 / ADR-065 / ADR-066)
...
Version: **v1.41** (2026-09-16). Slice/update of v1.40 (#111 ADR-065). Track N / N1 virtio-net first frame ([ADR-066](../03-adr/ADR-066-virtio-net-first-frame.md): discover + ARP TX/RX vs QEMU SLIRP; `net: ok`). Still **not** TCP/UDP/sockets/DHCP/DNS/Wi‑Fi/“has networking.” ADR-065 read CNTPCT pair unchanged. ADR-063 N0 scope unchanged. ADR-062/061/060/053/054/055 locks unchanged. Product freestanding app-hosting claim remains **Verified** under ADR-048/052. Still not Linux/POSIX/`mount`/`unlink`/`getdents`/containers/preemption/exFAT. Not a v2 model and not “secure.”
...
**Out:** Raspberry Pi or other boards, a second ISA, multi-tenant hosting, secure / measured boot, physical side channels, a hostile hypervisor. **Networking:** N1 virtio-net first-frame only ([ADR-066](../03-adr/ADR-066-virtio-net-first-frame.md)); not a TCP/UDP/sockets product stack.
...
| virtio-net (N1 first frame) | Guest programs a virtio-mmio net DMA master for one ARP TX/RX vs QEMU SLIRP. Not a TCP/UDP stack. | `src/virtio.rs` ([ADR-066](../03-adr/ADR-066-virtio-net-first-frame.md)) |
...
| **DMA / virtio devices** | **Named; bounded** | A7 programs virtio-mmio blk (one queue, poll `used.idx`, identity-PA DMA). N1 programs virtio-mmio net (RX+TX queues, same poll/DMA pattern) for one ARP frame ([ADR-066](../03-adr/ADR-066-virtio-net-first-frame.md)). QEMU is still TCB. A malicious virtio device is out (hostile hypervisor). No TCP/UDP stack. |
...
| **Network attacker** | **Named; bounded (link only)** | N1 attaches QEMU user netdev + guest virtio-net for one ARP exchange ([ADR-066](../03-adr/ADR-066-virtio-net-first-frame.md)). No TCP/UDP/sockets. QEMU SLIRP is still TCB. Hostile on-wire peers beyond this probe are out of product scope. |
...
| virtio-net first frame (N1) | Serial `net: virtio` / `net: mac` / `net: tx` / `net: rx` / `net: ok` | [ADR-066](../03-adr/ADR-066-virtio-net-first-frame.md). ARP vs QEMU SLIRP only. Not TCP/UDP/sockets. Host `-netdev` alone is not the probe. |
