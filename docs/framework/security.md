# Security — threat model v1.7 (NFR-10 / ADR-011 / ADR-012 / ADR-013 / ADR-014 / ADR-015 / ADR-016 / ADR-017 / ADR-018 / ADR-019)
...
| --- | --- | --- |
| Threat-model v1.7 written | Read this file | Verified (file + review). Still no “secure OS”. |
