# Security — threat model v1.21 (NFR-10 / ADR-011 / ADR-012 / ADR-013 / ADR-014 / ADR-015 / ADR-016 / ADR-017 / ADR-018 / ADR-019 / ADR-020 / ADR-021 / ADR-022 / ADR-023 / ADR-024 / ADR-025 / ADR-026 / ADR-027 / ADR-028 / ADR-030 / ADR-032 / ADR-037 / ADR-038 / ADR-039 / ADR-040 / ADR-041)
...
Version: **v1.21** (2026-09-13). Slice/update of v1.20 (adds IRQ-unmasked default standing/task `ERET`; FIQ/SError lower-EL still park; PAN enable still Planned). Not a v2 model and not “secure.”
...
| Remaining isolation gaps | Shared boot-stub text in the user table (handler must fetch if VBAR were still identity). No PAN enable on cortex-a57. Remaining identity RAM after the heap (frame bump). Lower-EL FIQ/SError still park. | User TTBR0 + ASID + TTBR1 + torn live `.text` / `.rodata` / `.data`/stacks / heap + EL0 entry without `VMALLE1` + lower-EL IRQ while standing + default IRQ-unmasked ERET + SVC ABI; isolation Planned |
