# Security — threat model v1.23 (NFR-10 / ADR-011 / ADR-012 / ADR-013 / ADR-014 / ADR-015 / ADR-016 / ADR-017 / ADR-018 / ADR-019 / ADR-020 / ADR-021 / ADR-022 / ADR-023 / ADR-024 / ADR-025 / ADR-026 / ADR-027 / ADR-028 / ADR-030 / ADR-032 / ADR-037 / ADR-038 / ADR-039 / ADR-040 / ADR-041 / ADR-042 / ADR-043)
...
Version: **v1.23** (2026-09-13). Slice/update of v1.22 (adds taken lower-EL FIQ while standing + SError park honesty; PAN enable still Planned; taken SError still Planned; umbrella isolation still Planned). Not a v2 model and not “secure.”
...
| Remaining isolation gaps | Shared boot-stub text in the user table (`ident: start-stay`). No PAN enable on cortex-a57. Remaining identity RAM after the heap (`ident: ram-stay`). Taken lower-EL SError still Planned (`el0: serror-park`). | User TTBR0 + ASID + TTBR1 + torn live `.text` / `.rodata` / `.data`/stacks / heap + EL0 entry without `VMALLE1` + lower-EL IRQ while standing + default IRQ-unmasked ERET + lower-EL FIQ while standing + SError park honesty + start-stay honesty + SVC ABI; isolation Planned ([ADR-043](../03-adr/ADR-043-lower-el-fiq-serror.md)) |
...
| SError park honesty | Serial `el0: serror-park` | No safe SError inject on this virt guest ([ADR-043](../03-adr/ADR-043-lower-el-fiq-serror.md)). Taken SError Planned. |
...
### Taken SError research (v1.24 note)

Research only ([ADR-044](../03-adr/ADR-044-taken-serror-research.md)): QMP/`nmi` on `virt` is the candidate host inject for a future taken lower-EL SError probe. Park marker remains Verified; taken path Planned. Not “EL0 isolated.”