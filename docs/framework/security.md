...
Version: **v1.55** (2026-09-19). Slice/update of v1.54 (#126 ADR-079). PAN enable + EL1-vs-EL0 fault ([ADR-080](../03-adr/ADR-080-pan-enable-fault.md) / [#125](https://github.com/artofdream/ctos/issues/125) mile 2): `pan: enabled` / `pan: el1-fault` on `-cpu cortex-a76`. Keep N1–N5 + samples + ADR-069/072/078/079. Still **not** “EL0 isolated” / BSD sockets / Linux/containers. Not a v2 model and not “secure.”
