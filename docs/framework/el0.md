...
| App hosting (Track A A8–A9) | Documented sample apps, OS/app slots ([issue #31](https://github.com/artofdream/ctos/issues/31)). The ABI + CRT + loader + standing-task + `.rodata` tear + memfs + FAT16 miles are not that. |
