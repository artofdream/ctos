...
M0–M9 are on `main` (M9 = merge of PR #15 / FR-11). ADR-011 / #17 through standing EL0 + TTBR1 first cut #24 are on `main`. This PR is the ADR-017 EL1 high-VA fetch mile. Merge is still a human/MRC job (ADR-002).
