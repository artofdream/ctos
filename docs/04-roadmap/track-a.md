...
| A5 | Isolation completion (remaining identity tear; PAN only if CPU + ADR) | **Identity tears Verified**; PAN CPU reopen **Accepted** ([ADR-079](../03-adr/ADR-079-pan-cpu-reopen.md) / [#125](https://github.com/artofdream/ctos/issues/125); `-cpu cortex-a76`, `pan: present`). PAN **enable** still locked (ADR-080). Umbrella non-claim ([ADR-055](../03-adr/ADR-055-el0-isolated-checklist.md)). Not “EL0 isolated.” |
