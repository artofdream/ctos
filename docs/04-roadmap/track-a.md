...
| A3 | ELF (or raw) loader into user TTBR0 | **Loader mile Verified** when the ledger has `loader: ok` on this tip ([#34](https://github.com/artofdream/ctos/issues/34), [ADR-023](../03-adr/ADR-023-elf-pt-load-loader.md)). Not a Linux ABI. Not app hosting. A4–A9 stay **Planned**. |
