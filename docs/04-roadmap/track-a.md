...
| --- | --- | --- |
| A1 | Stable SVC / syscall ABI + docs | **ABI mile** ([#32](https://github.com/artofdream/ctos/issues/32), [ADR-021](../03-adr/ADR-021-svc-syscall-abi.md), [syscall.md](../framework/syscall.md)). Verified only when the ledger has `svc: ok` on this tip. Not app hosting. |
