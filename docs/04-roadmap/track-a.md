...
| A7 | virtio-blk + FAT16 | **block + FAT mile Verified** on this tip when the ledger has `blk: ok` / `fat: ok` ([#38](https://github.com/artofdream/ctos/issues/38), [ADR-028](../03-adr/ADR-028-virtio-blk-fat16.md)). Same VFS `open`. FAT write depth: [ADR-050](../03-adr/ADR-050-fat16-write.md). Root listing: [ADR-056](../03-adr/ADR-056-fat16-readdir.md). Not POSIX. Not a Linux FS. |
