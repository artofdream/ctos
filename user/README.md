...
| Standing EL0 / `libctos` hello | [`hello-libctos/`](hello-libctos/README.md), `libctos/`, `build.rs`, `src/loader.rs` | same (or build the user crate first; A2–A4 still embed) | `libctos: hi` / `libctos: ok` / `loader: ok` / `el0: task-ok` |
...
Not claimed: POSIX, Linux ports, app hosting, A9 cross-update, “secure OS.”
