...
- Cloud Verified is this QEMU virt guest on `800f52d`, re-probed on `17778ca`, post-#62 `6abcb1b`, `7f52572`, and `4a6b4f7` (stale worktree prune + re-add). GHA Verified on `7f52572` is push [34702699720](https://github.com/artofdream/ctos/actions/runs/34702699720) + PR [34702702359](https://github.com/artofdream/ctos/actions/runs/34702702359). GHA on `70058db` / `4a6b4f7` is **Unknown** until grepped. Docker leftover and Darwin `shasum` stay Unknown (`command -v docker` empty here).
